...
const ContentB = () => {
  ...
  <h3 style={{ textAlign: 'center' }}>Library Images</h3>
      ...
      >
        <img
          style={{ width: '100%' }}
          src="https://placekitten.com/800/400" // Replace with your first image URL
          alt={`Slide ${currentImage}`}
        />
        
        <img
          style={{ width: '100%' }}
          src="https://placekitten.com/800/400" // Replace with your third image URL
